const request = require('lib/lib/request.js');
...
module.exports = (cfg, names, params, callback, stackError) => {
  ...
  let debugListeners = null;

  if (params._stream || params._stream === '') {
    streamListeners = params._stream;
  }

  if (params._debug || params._debug === '') {
    debugListeners = params._debug;
  }
  ...
  return request(
    cfg, 'POST', pathname, headers, body, names, MAX_REDIRECTS,
